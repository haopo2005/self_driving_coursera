    ...
    def select_best_path_index(self, paths, collision_check_array, goal_state):
        ...
        for i in range(len(paths)):
            ...
            if collision_check_array[i]:
                ...
                # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
                # --------------------------------------------------------------
                x_path_last = paths[i][0][-1]
                y_path_last = paths[i][1][-1]
                score = np.sqrt((x_path_last-goal_state[0])**2+(y_path_last-goal_state[1])**2)
                # --------------------------------------------------------------
                ...
                for j in range(len(paths)):
                    if j == i:
                        ...
                        if not collision_check_array[j]:
                            # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
                            # --------------------------------------------------
                            close_dist = np.sqrt((paths[i][0][-1] - paths[j][0][-1])**2+(paths[i][1][-1] - paths[j][1][-1])**2)
                            score += self._weight / close_dist
                            # --------------------------------------------------
                            pass
